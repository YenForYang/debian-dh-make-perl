...
use constant debstdversion => '4.3.0';
...
sub discover_utility_deps {
    ...
    ) if ( $build_deps->has('libmodule-build-tiny-perl') or
          $build_deps_indep->has('libmodule-build-tiny-perl') );
    ...
    # Ensure both libmodule-build{,tiny}-perl and perl are in B-D
    # (and not in B-D-I).
...
=item Copyright (C) 2007-2018 gregor herrmann <gregoa@debian.org>
